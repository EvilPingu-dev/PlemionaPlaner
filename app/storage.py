...
PLAYER_POINTS_FILE = DATA_DIR / "player_points.json"  # {player_name: tw_points}  from TW API
TARGET_POINTS_FILE = DATA_DIR / "target_points.json"  # {target_coord: owner_tw_points}  from TW API
...
CANCELLED_TARGETS_FILE     = DATA_DIR / "cancelled_targets.json"      # ["x|y", …]
...
DEFAULT_SETTINGS: dict = {
    ...
    "noble_priority_players":  ["MidnightRain x KRTFL"],  # players who always get noble assignments first
    "greeting": (
        "Witam,\n"
